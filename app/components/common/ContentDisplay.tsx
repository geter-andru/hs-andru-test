...
const ContentDisplay: React.FC<ContentDisplayProps> = ({ content, className = '' }) => {
      ...
      <div className={`space-y-4 ${className}`}>
        ...
        {(parsedContent.segments || parsedContent.customerSegments) && Array.isArray(parsedContent.segments || parsedContent.customerSegments) && (
          <div className="space-y-3">
            ...
            {(parsedContent.segments || parsedContent.customerSegments).map((segment: any, index: number) => (
        ...
        {parsedContent.categories && Array.isArray(parsedContent.categories) && (
          <div className="space-y-3">
            ...
            {parsedContent.categories.map((category: any, index: number) => (
              <div key={index} className="bg-surface/50 rounded-lg p-4 border border-glass-border">
        ...
        {parsedContent.templates && Array.isArray(parsedContent.templates) && (
          <div className="space-y-3">
            ...
            {parsedContent.templates.map((template: any, index: number) => (
              <div key={index} className="bg-surface/50 rounded-lg p-4 border border-glass-border">
                <div className="flex items-center justify-between mb-2">
                ...
                {template.keyPoints && (
                  <div className="mt-3 space-y-1">
                    ...
                    <ul className="text-xs text-secondary space-y-1">
                      {template.keyPoints.map((point: string, idx: number) => (
                        <li key={idx} className="flex items-start">
                          <span className="text-brand mr-2">•</span>
                          {point}
                        </li>
        ...
        {parsedContent.keyIndicators && Array.isArray(parsedContent.keyIndicators) && (
          <div className="space-y-2">
            ...
            <ul className="space-y-1">
              {parsedContent.keyIndicators.map((indicator: string, index: number) => (
        ...
        {parsedContent.ratingCriteria && Array.isArray(parsedContent.ratingCriteria) && (
          <div className="space-y-3">
            ...
            {parsedContent.ratingCriteria.map((criteria: any, index: number) => (
        ...
        {parsedContent.frameworks && Array.isArray(parsedContent.frameworks) && (
          <div className="space-y-3">
            ...
            {parsedContent.frameworks.map((framework: any, index: number) => (
              <div key={index} className="bg-surface/50 rounded-lg p-4 border border-glass-border">
                ...
                {framework.components && (
                  <ul className="text-sm text-secondary space-y-1">
                    {framework.components.map((component: string, idx: number) => (
                      <li key={idx} className="flex items-start">
                        <span className="text-brand mr-2">•</span>
                        {component}
                      </li>
        ...
        {parsedContent.successMetrics && Array.isArray(parsedContent.successMetrics) && (
          <div className="space-y-3">
            ...
            {parsedContent.successMetrics.map((metric: any, index: number) => (
              <div key={index} className="bg-surface/50 rounded-lg p-3 border border-glass-border">
                <h5 className="font-medium text-primary mb-2">{metric.category}</h5>
                <ul className="text-sm text-secondary space-y-1">
                  {metric.metrics.map((m: string, idx: number) => (
                    <li key={idx} className="flex items-start">
                      <span className="text-brand mr-2">•</span>
                      {m}
                    </li>
      ...
      <div className={`space-y-4 ${className}`}>
                  ...
                  {isExpanded && (
                    <div className="px-4 pb-4">
                      <div 
                        ...
                        dangerouslySetInnerHTML={{ __html: sectionContent as string }}
                      />
                    </div>
                  )}
                </div>
        ...
        {parsedContent.interactive && parsedContent.interactive.scoring_criteria && (
          <div className="space-y-3">
            ...
            {parsedContent.interactive.scoring_criteria.map((criteria: any, index: number) => (
        ...
        {parsedContent.interactive && parsedContent.interactive.rating_questions && (
          <div className="space-y-3">
            ...
            {parsedContent.interactive.rating_questions.map((question: any, index: number) => (
              <div key={index} className="bg-gray-700 rounded-lg p-4 border border-gray-600">
                <div className="mb-3">
...
export const ListDisplay: React.FC<ListDisplayProps> = ({ items, ordered = false, className = '' }) => {
...
export const DefinitionList: React.FC<DefinitionListProps> = ({ items, className = '' }) => {
