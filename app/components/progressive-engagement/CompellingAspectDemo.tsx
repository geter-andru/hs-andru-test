...
interface ICPDemoData {
  title: string;
  subtitle: string;
  companies: CompanyData[];
  interactionPrompt: string;
  compellingInsight: string;
}
...
interface BusinessCaseDemoData {
  title: string;
  subtitle: string;
...
type DemoData = ICPDemoData | FinancialDemoData | BusinessCaseDemoData;
...
interface CompellingAspectDemoProps {
  aspectType: string;
  onEngageWith: (aspectType: string, data?: InteractionData) => void;
  customerData?: any;
}

interface ICPRatingDemoProps {
  data: ICPDemoData;
  onInteraction: (interactionType: string, data?: any) => void;
  isInteractive: boolean;
}

interface FinancialImpactDemoProps {
  data: FinancialDemoData;
  onInteraction: (interactionType: string, data?: any) => void;
  isInteractive: boolean;
}

interface BusinessCaseDemoProps {
  data: BusinessCaseDemoData;
  onInteraction: (interactionType: string, data?: any) => void;
  isInteractive: boolean;
}
...
const CompellingAspectDemo: React.FC<CompellingAspectDemoProps> = ({ 
  ...
  const getICPRatingDemo = (): ICPDemoData => ({
  ...
  const getCostImpactDemo = (): FinancialDemoData => ({
  ...
  const getBusinessCaseDemo = (): BusinessCaseDemoData => ({
  ...
  return (
    ...
    >
      ...
      {aspectType === 'financial_impact' && (
        <FinancialImpactDemo 
          data={demoData as FinancialDemoData} 
          onInteraction={handleInteraction}
          isInteractive={isInteractive}
        />
      )}
      ...
      {aspectType === 'business_case' && (
        <BusinessCaseDemo 
          data={demoData as BusinessCaseDemoData} 
          onInteraction={handleInteraction}
          isInteractive={isInteractive}
        />
      )}
...
const ICPRatingDemo: React.FC<ICPRatingDemoProps> = ({ data, onInteraction, isInteractive }) => {
...
const FinancialImpactDemo: React.FC<FinancialImpactDemoProps> = ({ data, onInteraction, isInteractive }) => {
...
const BusinessCaseDemo: React.FC<BusinessCaseDemoProps> = ({ data, onInteraction, isInteractive }) => {
