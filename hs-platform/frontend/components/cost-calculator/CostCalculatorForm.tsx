        ...
        return (
          ...
          >
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-white mb-2">Revenue Impact</h2>
              <p className="text-white">How much revenue is at risk?</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-white mb-2">
                  Average Deal Size ($)
                  <span className="text-xs text-white ml-1">(Typical contract value)</span>
                </label>
                <input
                  type="number"
                  {...register('averageDealSize', { required: 'Deal size is required', min: 1 })}
                  placeholder="25000"
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white placeholder-gray-500 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                />
              ...
              <div>
                <label className="block text-sm font-medium text-white mb-2">
                  ...
                  <span className="text-xs text-white ml-1">(Average per month)</span>
                </label>
                <input
                  type="number"
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white placeholder-gray-500 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                />
                <p className="text-xs text-white mt-1">Enter as decimal (e.g., 0.15 for 15%)</p>
              </div>
        ...
        return (
          ...
          >
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-white mb-2">Operational Costs</h2>
              <p className="text-white">Current efficiency and waste</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white placeholder-gray-500 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                />
                <p className="text-xs text-white mt-1">Percentage of time/resources wasted (as decimal)</p>
              </div>
            </div>
          </motion.div>
        );
        ...
        return (
          ...
          >
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-white mb-2">Market Position</h2>
              <p className="text-gray-600">Competitive risks of waiting</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white placeholder-gray-500 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                />
                <p className="text-xs text-white mt-1">Enter as decimal (e.g., 0.05 for 5%)</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white placeholder-gray-500 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                />
                <p className="text-xs text-white mt-1">Rate at which competitors gain advantage</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white placeholder-gray-500 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                />
                <p className="text-xs text-white mt-1">Current customer retention rate</p>
              </div>
            </div>
          </motion.div>
        );
        ...
        return (
          ...
          >
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-white mb-2">Timeline & Context</h2>
              <p className="text-gray-600">Timing and business context</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-white mb-2">
                  Delay Period (months)
                  <span className="text-xs text-white ml-1">(How long they'll wait)</span>
                </label>
                <input
                  type="number"
                  ...
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white placeholder-gray-500 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                />
                <p className="text-xs text-white mt-1">How long will implementation be delayed?</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white placeholder-gray-500 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                />
                <p className="text-xs text-white mt-1">Time needed to fully implement solution</p>
              </div>
                ...
                {painPointOptions.map((pain) => (
                  <label key={pain} className="flex items-center">
                    <input
                      ...
                      value={pain}
                      {...register('painPoints')}
                      className="rounded border-gray-700 bg-gray-800 text-green-400 focus:ring-green-500"
                    />
            ...
            <div className="bg-gradient-to-r from-green-900/20 to-blue-900/20 border border-gray-800 rounded-lg p-4">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="bg-gray-900 border border-gray-800 rounded-xl p-8">
        ...
        <div className="flex justify-between mt-8 pt-6 border-t border-gray-800">
          ...
          {step < totalSteps ? (
            ...
            >
              <span>{isLoading ? 'Calculating...' : 'Calculate Deal Value'}</span>
