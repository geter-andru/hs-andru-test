    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-3">
          <select
            ...
            className="border border-gray-700 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
          >
          ...
          {selectedItems.length > 0 && (
            <div className="flex space-x-2">
              <button className="flex items-center space-x-1 px-3 py-2 border border-gray-700 rounded-lg hover:bg-gray-800 text-sm">
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <label className="flex items-center">
            ...
            />
            <span className="ml-2 text-sm text-gray-300">Select all calculations</span>
          </label>
        </div>
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div className="flex space-x-2">
                    <button 
                      ...
                      className="p-2 text-gray-400 hover:text-gray-400 rounded-lg hover:bg-gray-700"
                    >
                      <EyeIcon className="h-4 w-4" />
                    </button>
                    <button className="p-2 text-gray-400 hover:text-gray-400 rounded-lg hover:bg-gray-700">
                      <ArrowDownTrayIcon className="h-4 w-4" />
                    </button>
                  </div>
                </div>
      ...
      {mockHistory.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-white mb-2">No Calculation History</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-4 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-2xl font-bold text-white">{mockHistory.length}</div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-4 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-sm text-gray-400">Total Cost Identified</div>
            </div>
