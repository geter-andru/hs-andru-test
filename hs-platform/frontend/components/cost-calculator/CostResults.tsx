  ...
  if (!results) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-lg font-medium text-white mb-2">No Deal Value Calculated</h3>
        <p className="text-gray-400 mb-6">
          Calculate deal value to create urgency and build executive business cases.
        </p>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-white">Deal Value & Business Case</h2>
          ...
          {results.scenarios.map((scenario, index) => (
            <div key={scenario.name} className="text-center">
              <div className="bg-gray-50 rounded-lg p-4">
                <h4 className="text-sm font-medium text-white mb-2">{scenario.name}</h4>
                <div className="text-2xl font-bold text-white">{formatCurrency(scenario.totalCost)}</div>
      ...
      >
        <h3 className="text-lg font-semibold text-white mb-2">Ready to Present?</h3>
        <p className="text-gray-400 mb-4">
          Your executive presentation and stakeholder materials are ready to use.
        </p>
        <div className="flex justify-center space-x-4">
          <button className="bg-indigo-600 text-white px-6 py-2 rounded-lg hover:bg-indigo-700">
            Get Sales Materials
          </button>
          <button className="border border-gray-300 text-gray-300 px-6 py-2 rounded-lg hover:bg-gray-50">
            Send to CRM
          </button>
        </div>
      </motion.div>
