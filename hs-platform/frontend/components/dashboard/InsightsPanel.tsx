  ...
  const displayInsights = Array.isArray(insights) ? insights : [
    {
      ...
      description: 'Your prospect qualification shows 3 enterprise segments with 90%+ fit scores.',
    ...
    },
    {
      id: '2',
      type: 'tip' as const,
      title: 'Calculate Deal Value',
      description: 'Add competitive analysis data to strengthen your executive presentation.',
    ...
    },
    {
      ...
      title: 'Revenue Intelligence Progress',
      description: 'You\'re 80% through developing advanced prospect qualification skills.',
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-6">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-semibold text-gray-900">Sales Insights</h2>
        <span className="text-sm text-gray-500">Intelligent</span>
      </div>
      ...
      {displayInsights.length === 0 && (
        <div className="text-center py-8 text-gray-500">
          ...
          <p className="text-sm mt-1">Use the sales tools to get intelligent recommendations</p>
        </div>
      )}
