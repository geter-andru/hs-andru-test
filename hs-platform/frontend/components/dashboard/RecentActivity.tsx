...
export function RecentActivity({ activities, isLoading }: RecentActivityProps) {
  ...
  const displayActivities = activities || [
    {
      id: '1',
      action: 'Prospect Qualification Started',
    ...
    {
      id: '3',
      action: 'Development Milestone',
      description: 'Completed "Customer Analysis" objective',
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-6">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-semibold text-gray-900">Recent Sales Activity</h2>
      ...
      {displayActivities.length === 0 && (
        <div className="text-center py-8 text-gray-500">
          ...
          <p className="text-sm mt-1">Start using the sales tools to see your activity here</p>
        </div>
      )}
    </div>
  );
