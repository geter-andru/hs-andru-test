...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Background Colors (Dark Theme) - Matching Design Tokens
        background: {
          primary: '#0f172a',      // --bg-main (slate-900)
          secondary: '#1e293b',    // --bg-card (slate-800)  
          tertiary: '#334155',     // --bg-section (slate-700)
          elevated: '#475569',     // --bg-input (slate-600)
          pure: '#0a0a0a',         // Pure black like assessment
        },
        surface: {
          DEFAULT: '#334155',      // --bg-section (slate-700)
          hover: '#475569',        // --bg-input (slate-600)
        },
